...
//		배열생성시 몇개의 요솔르 저장할지 갯수 지정
	...
	//초기화 
	//배열변수 =new 자료형[갯수];
 //회원 정보(uid,pwd,age)를 저장하는 배열 생성	
	String[] uid;
	String[] pwd;
	int[] age;
	
	uid= new String[3]; //3명분의 아이디를 저장할 수 있는 배열변수생성
	//3명분의 아이디를 저장할수 있는 배열 변수 새엉
	//new: 참조형 객체를 생성하라는 의미의 연산자
	//기본 자료형 객체는 변수에 실제 값이 저장됨
	//참조 자료형 객체는 변수에 그값에 대한 위치값이 저장됨
	...
	//참조형 변수를 출력하면 그변수가 저장된 곳의 시작번지가 출력됨
    //그변수값이 저장된 곳의 시작 번지가 출력됨
	
	//JVM의 메모리 구조
	
	//스택: 일반적인 변수가 선언될때 사용하는 공간
    //      기본자료형/참조자료형 변수들이 주로사용
	...
	//배열의 요소의 값 다루기 
	//배열명 [인덱스]=값; // 배열의 특정요소의 값 저장 
	uid[0]="abc123";
	uid[1]="abc987";
	uid[2]="abc456";

	//배열의 요소를 출력하려면 배열명[인덱스]형태로 사용
	//배열의 요솔르 다룰때는 반복문을 사용할것!
...
//	
	...
	//임의의 숫자 : 난수 random
	//Random 클래스를 이용하면 원하는 형태의 난수생성가능
	//
	int[] lotto=new int[6];
